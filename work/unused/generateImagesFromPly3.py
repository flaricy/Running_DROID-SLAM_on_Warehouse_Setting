...
def set_camera_intrinsics(ctr, K, image_size):
    ...
    #print("intrinsic:", camera_params.intrinsic.intrinsic_matrix)
    #exit(-1)
...
#     # 1, 2, 0; +++, -++; --+; -+-; 3 must be +; +-+; 2-10; 1-20; 
#     ## * 一开始
#     ## * translation[0]是第一次转完后方向的前后; 第0个位置控制第一个
#     ## * 
#     ## * 原本的translation[1]是上下 !!
#     translation = [translation[2], 0, 0]  # 交换 y 和 z
...
if __name__ == "__main__":
    # 文件路径
    ply_file_path = "work/screen_capture/all_frames.ply"  # 修改为实际点云文件路径
    poses_file_path = "reconstructions/warehouse/traj_est.npy"  # 修改为实际位姿文件路径
    output_dir = "work/screen_capture/rendered_frames000/"  # 输出图片目录
    ...
    render_point_cloud_from_poses(ply_file_path, poses_file_path, intrinsic_file_path, output_dir, 
                                  ...
                                  #image_size=(int(2 * height), int(2 * width)))